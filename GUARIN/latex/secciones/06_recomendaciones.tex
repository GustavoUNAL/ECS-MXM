...
El aporte del SSFV referido a media tensión es del orden de 0,008~kA (0,15\% de $I_{k3}$), frente a 5,120~kA trifásicos en el punto de conexión. La variación de $I_k$ en el bus respecto al caso base es nula a la resolución del cálculo IEC~60909, porque el inversor se modela como fuente de corriente. En estas condiciones, no se requieren cambios en el relé MICOM~P142 ni en los ajustes de las funciones 50/51/50N/51N del circuito 10-502.
