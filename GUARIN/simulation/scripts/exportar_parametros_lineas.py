...
Salida:
  GUARIN/simulation/results/lineas_parametros.csv
"""
...
# Ruta ABSOLUTA de salida (PowerFactory a veces no resuelve __file__)
_SCRIPT_DIR = Path(__file__).resolve().parent
OUTPUT_DIR = str(_SCRIPT_DIR.parent / "results")
