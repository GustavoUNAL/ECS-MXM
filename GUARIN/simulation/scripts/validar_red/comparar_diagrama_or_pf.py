# -*- coding: utf-8 -*-
"""
Comparar diagrama CTO 10 502 vs OR vs modelo PF — sin modificar PowerFactory.

Salida: resultados de scripts/validar_red/comparacion_diagrama.txt

Uso:
  python comparar_diagrama_or_pf.py
"""
...
BASE = LINEAS_BASE
PF = PF_EXPORT
OUT = ensure_results_validar() / "comparacion_diagrama.txt"
...
if not PF.is_file():
    print(f"AVISO: exporta primero lineas desde PF -> {PF.name}")
